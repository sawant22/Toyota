 ...
 */
class CustomerCommentsAttribute implements DataPatchInterface
{
    /**
     * @var EavSetupFactory
     */
    ...
    public function apply()
    {
        ...
        $attributes = [
            'customer_copy_comments' => [
                'group_name' => 'PDP Custom Attributes',
                'type' => 'varchar',
                'label' => 'Customer Copy Comments',
                'input' => 'textarea',
                'source' => '',
                'option' => '',
                'filterable' => false,
    ...
    private function updateProductAttribute()
    {
		...
		$eavSetup->updateAttribute($entityType, 'customer_copy_comments', 'is_wysiwyg_enabled', 1, null);
	}
